<%@ Page Title="" Language="C#" MasterPageFile="~/Ogretmen.Master" AutoEventWireup="true" CodeBehind="OgrenciGuncelle.aspx.cs" Inherits="Ogrenci_Not_Sistemi.OgrenciGuncelle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="Form1" runat="server">
        ...
        <asp:Button ID="ogrGuncelle" runat="server" CssClass="btn btn-info" Text="Güncelle" OnClick="ogrGuncelle_Click"  />
    </form>
</asp:Content>
